...
Tag array contents _must_ be primitive string values. Any non-string values will br coerced into strings.
...
If you accidentally delete the frontmatter with the associated Anki `noteId` in your local Markdown note, Yanki will do its best to repair the frontmatter and re-associate your Markdown notes with your existing Yanki notes.
...
| `--check-database`             | Automatically run Anki's "Check Database" command after note model updates that might produce database corruption. In Yanki 1.0.2 and earlier, `--check-database false` was the default behavior. Starting with version 1.1.0, it is enabled by default.                                                                                                                                                                                                                                                                            | `boolean`                            | `true`                    |
| `--strict-line-breaks`<br>`-b` | Set to false to treat single newlines in Markdown as line breaks.                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | `boolean`                            | `true`                    |
